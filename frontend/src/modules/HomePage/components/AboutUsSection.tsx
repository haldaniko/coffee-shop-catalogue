              ...
              <li className="bg-background/100">
                <details className="border-2 rounded-lg border-primary/100 dark:open:bg-slate-900 open:ring-1 open:ring-black/5 dark:open:ring-white/10 open:shadow-lg p-4">
                  ...
                  <div className="relative pt-4 font-primary text-[24px] leading-[36px] text-secondary/100">
                    ...
                    ></span>
                    <p className="pl-7">
                      We are a team of enthusiasts who unite people through the
                      love of coffee. Our service is . created for those who
                      cannot imagine their day without an aromatic cup of coffee
                      in a cozy place. We help you find the best coffee shops in
                      your city - from cozy family cafes to stylish urban coffee
                      shops.
                    </p>
                  </div>
                </details>
              ...
              <li className="bg-background/100">
                <details className="border-2 rounded-lg border-primary/100 dark:open:bg-slate-900 open:ring-1 open:ring-black/5 dark:open:ring-white/10 open:shadow-lg p-4">
                  ...
                  <div className="relative pt-4 font-primary text-[24px] leading-[36px] text-secondary/100">
                    ...
                    ></span>
                    <p className="pl-7">
                      Our mission is to make every coffee break special, helping
                      you discover new places to meet, work and relax. Thanks to
                      our recommendations, you will always be able to find the
                      perfect place for your coffee – whether it&apos;s a
                      morning coffee work, a Sunday brunch or an evening meeting
                      with friends.
                    </p>
                  </div>
                </details>
              ...
              <li className="bg-background/100">
                <details className="border-2 rounded-lg border-primary/100 dark:open:bg-slate-900 open:ring-1 open:ring-black/5 dark:open:ring-white/10 open:shadow-lg p-4">
                  ...
                  <div className="relative pt-4 font-primary text-[24px] leading-[36px] text-secondary/100 mb-[24px]">
                    ...
                    ></span>
                    <p className="pl-7">
                      Join us, and together we will open the world of coffee
                      shops, where everyone will find something special.
                    </p>
                  </div>
